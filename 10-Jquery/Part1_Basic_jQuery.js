...
// Save it to variable: -> $  instead of document.querySelectorAll
var x = $('h1');

// You can easily edit the css properties: -> first property and then what I want to change
x.css("color", 'red');
...
// Grabbing multiple returns an array-like object: - getting all lists in here
var listItems = $('li');
...
// Toggle the Class on and Off =>better way, toggling it on and off
